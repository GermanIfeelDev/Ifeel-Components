...
@Composable
internal fun SurveySingleOptionButton(
    text: String,
    onClick: () -> Unit,
    ...
    Button(
        ...
        colors = ButtonDefaults.buttonColors(
            containerColor = if (isPressed) color_brand_primary_400 else Color.White,
        ),
        ...
        Text(
            ...
            style = BodyTextStyle.Body16Regular.toTextStyle().copy(
                color = if (isPressed) Color.White else color_text_700
            )
        )
    }
}
...
@Composable
internal fun SurveyMultipleOptionButton(
    text: String,
    selected: Boolean,
